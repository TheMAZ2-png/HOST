    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignTableToServers", x => x.EmployeeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PartyName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClockOutByEmployeeId = table.Column<int>(type: "int", nullable: true),
                    ClockInByEmployeeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeShifts", x => x.ShiftId);
                    table.ForeignKey(
                        name: "FK_EmployeeShifts_Employees_ClockInByEmployeeId",
                        column: x => x.ClockInByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId");
                    table.ForeignKey(
                        name: "FK_EmployeeShifts_Employees_ClockOutByEmployeeId",
                        column: x => x.ClockOutByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartyId = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    PublicAccessCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeatingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AssignedServerId = table.Column<int>(type: "int", nullable: false),
                    SeatedByEmployeeId = table.Column<int>(type: "int", nullable: false),
                    RestaurantTableId = table.Column<int>(type: "int", nullable: false),
                    PartyId = table.Column<int>(type: "int", nullable: false),
                    SeatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seatings_Employees_AssignedServerId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "EmployeeId");
                    table.ForeignKey(
                        name: "FK_Seatings_Employees_SeatedByEmployeeId",
                        column: x => x.SeatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Seatings_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "PartyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Seatings_RestaurantTables_RestaurantTableId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeShifts_ClockInByEmployeeId",
                table: "EmployeeShifts",
                column: "ClockInByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeShifts_ClockOutByEmployeeId",
                table: "EmployeeShifts",
                column: "ClockOutByEmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seatings_AssignedServerId",
                table: "Seatings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seatings_PartyId",
                table: "Seatings",
                column: "PartyId");

            migrationBuilder.CreateIndex(
                name: "IX_Seatings_RestaurantTableId",
                table: "Seatings",
                column: "RestaurantTableId");

            migrationBuilder.CreateIndex(
                name: "IX_Seatings_SeatedByEmployeeId",
                table: "Seatings",
                column: "SeatedByEmployeeId");
